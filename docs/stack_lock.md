...
Last repo-side update: 2026-07-01.
...
| Native OCI site status | enabled; strict E2E passed on 2026-07-01 |
...
| Scope | Bundle path |
|---|---|
| Base runtime | `/data/groups/autonomous/oci-bundles/users/$USER/jwst-base/current` |
| OpenUSD tools | `/data/groups/autonomous/oci-bundles/users/$USER/jwst-usd-tools/current` |
| Isaac Sim / Replicator | `/data/groups/autonomous/oci-bundles/users/$USER/jwst-isaac-sim/current` |
| Isaac Lab / policy | `/data/groups/autonomous/oci-bundles/users/$USER/jwst-isaac-lab/current` |
| Astro data prep | `/data/groups/autonomous/oci-bundles/users/$USER/jwst-astro-data/current` |
...
`/data/groups/autonomous/runs/20260701T011642Z-jwst-e2e`
from commit `dbfc31fce2bf04f35702b1bb3c3b9b1fd77bb7aa`.
